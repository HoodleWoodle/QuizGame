...
public final class GameFrame extends JFrame
{
	...
	/**
	 * Sets the properties minimum Dimension @param min, preferred Dimension @param preferred, and maximum Dimension @param max for the components @components.
	 *
	 * @param min
	 ...
	 *
	 * @param client
	 *            the AbstractTCPClient implementation
	 * @param control
	...
	public GameFrame(AbstractTCPClient client, IControl control, IModel model)
	{
		...
		addWindowListener(new WindowAdapter()
		{
			...
			public void windowClosing(WindowEvent event)
			{
				...
				{
					int answer = JOptionPane.showConfirmDialog(GameFrame.this, localization.getString("CONFIRM_LEAVE"), localization.getString("CONFIRM_LEAVE_SCREEN_TITLE"), JOptionPane.YES_NO_OPTION);
					if (answer == JOptionPane.YES_OPTION) stop(client);
				}
				else stop(client);
			}
		});
